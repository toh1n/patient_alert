...
import 'package:patient_alert/utils.dart';
...
class _AvailableDeviceScreenState extends State<AvailableDeviceScreen> {
  ...
  void initState() {
    ...
    if (!(Permission.notification.isDenied == true ||
        Permission.bluetooth.serviceStatus.isDisabled == true ||
        Permission.location.isDenied == true)) {
      _getStoredMessage();
  ...
  Widget build(BuildContext context) {
    return Visibility(
      ...
      child: Visibility(
        visible: (Permission.notification.isDenied == true ||
                Permission.location.isDenied == true) ==
            false,
        replacement: Center(
          child: Column(
            ...
            children: [
              Visibility(
                visible: Permission.location.isDenied == true,
                replacement: const Text("Location Permission Granted"),
              ...
              Visibility(
                visible: Permission.notification.isDenied == true,
                replacement: const Text("Notification Permission Granted"),
                child: ElevatedButton(
                    onPressed: () {
                      Permission.notification.request();
                      setState(() {});
                    },
                    child: const Text("Ask for Notification Permission")),
              ),
            ],
          ),
        ),
